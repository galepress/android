    ...
    public boolean onScale(ScaleGestureDetector detector) {
        ...
        if (!mReflow) {
            ...
            if (v != null) {
				...
				/*
                * Burada sadece onScaleChild(v, mScale); vardi.
                * Sayfayi scale ederken sol ust koseye dogru scale ediyordu
                * Bu satirlari ekleyerek scale islemini sayfanin neresine yapiyosa oraya gore ayalandi. (MG)
		        * */
