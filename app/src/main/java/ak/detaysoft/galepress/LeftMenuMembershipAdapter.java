    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(GalePressApplication.getInstance().getMembershipMenuList().get(position) == LOGIN) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_LOGIN));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_LOGIN));
        }
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_RESTORE));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_RESTORE));
        }
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_SUBSCRIPTION));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_SUBSCRIPTION));
        }
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_LOGOUT));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MEMBERSHIP_LOGOUT));
        }
