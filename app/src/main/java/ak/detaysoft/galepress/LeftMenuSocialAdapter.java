    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mList.get(position).getKey().toLowerCase().contains("facebook")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.FACEBOOK_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.FACEBOOK_ICON));
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                ...
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.LINKEDIN_ICON));
        } else if(mList.get(position).getKey().toLowerCase().contains("web")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.WEB_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.WEB_ICON));
        } else if(mList.get(position).getKey().toLowerCase().contains("mail")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MAIL_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.MAIL_ICON));
        } else if(mList.get(position).getKey().toLowerCase().contains("google") && mList.get(position).getKey().toLowerCase().contains("plus")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.GOOGLE_PLUS_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.GOOGLE_PLUS_ICON));
        } else if(mList.get(position).getKey().toLowerCase().contains("pinterest")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.PINTEREST_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.PINTEREST_ICON));
        } else if(mList.get(position).getKey().toLowerCase().contains("tumblr")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.TUMBLR_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.TUMBLR_ICON));
        } else if(mList.get(position).getKey().toLowerCase().contains("youtube")) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                image.setBackground(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.YOUTUBE_ICON));
            else
                image.setBackgroundDrawable(ApplicationThemeColor.getInstance().paintIcons(mContext, ApplicationThemeColor.YOUTUBE_ICON));
        } else
