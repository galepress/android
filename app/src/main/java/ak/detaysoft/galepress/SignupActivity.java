...
public class SignupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseView = (LinearLayout) findViewById(R.id.signup_base_view);
        ...
        popup = ((RelativeLayout)findViewById(R.id.activity_signup_popup));
        ...
        CustomPulseProgress progress = (CustomPulseProgress)findViewById(R.id.activity_signup_loading);
        progress.startAnim();

        WebView web = (WebView)findViewById(R.id.activity_signup_web);
        ...
        try{
            ...
            Toast.makeText(SignupActivity.this, getResources().getString(R.string.cannot_load), Toast.LENGTH_SHORT).show();
            Intent intent = getIntent();
            setResult(102, intent);
            finish();
        }
