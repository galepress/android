...
public class ViewAnnotation extends View {
    ...
    public LinkInfoInternal linkInfoInternal;
    ...
    public ViewAnnotation(Context context, LinkInfoExternal linkInfoExternal) {
        super(context);
        this.context = context;
    ...
    public ViewAnnotation(Context context, LinkInfoInternal linkInfoInternal) {
        super(context);
        this.context = context;
        this.linkInfoInternal = linkInfoInternal;
        viewAnnotation = this;
        setCustomTouchListener();
    }
