...
import ak.detaysoft.graff.custom_models.Subscription;
import ak.detaysoft.graff.custom_models.TabbarItem;
import ak.detaysoft.graff.custom_models.UserInformations;
...
public class GalePressApplication
    ...
    public void onCreate() {
        ...
        SharedPreferences verificationPreferences = getSharedPreferences("ak.detaysoft.graff", Context.MODE_PRIVATE);
        ...
        if (isTestApplication()) {
            ...
            preferences = getSharedPreferences("ak.detaysoft.graff", Context.MODE_PRIVATE);
    ...
    void displayMessageOnScreen(Context context, String message) {
        ...
        Intent intent = new Intent("ak.detaysoft.graff.DISPLAY_MESSAGE");
    ...
    public void initUser(){
        SharedPreferences preferences = getSharedPreferences("ak.detaysoft.graff", Context.MODE_PRIVATE);
